...
public final class ActivitySplashBinding implements ViewBinding {
  ...
  private ActivitySplashBinding(@NonNull LinearLayout rootView, @NonNull ImageView appIcon,
      @NonNull TextView appNameText) {
  ...
  public static ActivitySplashBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySplashBinding((LinearLayout) rootView, appIcon, appNameText);
    }
